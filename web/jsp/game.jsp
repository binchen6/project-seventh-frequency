...
<div class="stat-help-section">
<div class="stat-help-title">📊 数值说明</div>
<div class="stat-help-grid">
<div class="stat-help-item"><span class="stat-name">推理</span><span class="stat-desc">影响隐藏线索和推理分支的解锁</span></div>
<div class="stat-help-item"><span class="stat-name">人心</span><span class="stat-desc">影响角色情感认同和信任度</span></div>
<div class="stat-help-item"><span class="stat-name">行动</span><span class="stat-desc">影响快速反应和突破的选择</span></div>
<div class="stat-help-item"><span class="stat-name">技术</span><span class="stat-desc">影响频率设备和声波机制的理解深度</span></div>
<div class="stat-help-item"><span class="stat-name">线索</span><span class="stat-desc">解锁特殊分支和隐藏剧情</span></div>
<div class="stat-help-item"><span class="stat-name">弦外</span><span class="stat-desc">触及故事更深层秘密的稀有参数</span></div>
</div>
</div>
<div class="settings-actions">
<button class="ctrl-btn" id="resetSettings">恢复默认</button>
<button class="ctrl-btn" id="applySettings">完成</button>
<button class="ctrl-btn" id="btnLogout" style="margin-top:12px;opacity:.55;font-size:.78rem">🔄 切换档案</button>
</div>
</div>
</div>
